...
$C$ est en $g/L$ si $m_{soluté}$ est en $g$ et $V_{solution}$ en $L$.
:::
...
$$
V_{solution} = \frac{m_{soluté}}{C}
$$

::: warning Attention
Il est important de distinguer la masse volumique $\rho$ de la concentration en masse $C$. En effet, même si à première vue les relations sont identiques,
$\rho = \frac{m}{V}$ et $C = \frac{m}{V}$, les masses et volumes dans les relations ne sont pas les mêmes.
...
Pour la concentration en masse de sucre, il faut identifier la masse soluté et le volume de solution : $C = \frac{m_{soluté}}{V_{solution}} = \frac{20 g}{0,100 L} = 200 g/L$.
:::
